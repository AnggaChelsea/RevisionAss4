...
tournaments: any;
  ...
  constructor(private csvService:CsvService,
    ...
    private cd: ChangeDetectorRef,private tournamentService: TournamentService,
  ...
  downloadFile(data:any, filename = 'data') {
    let arrHeader = ['name','age', 'average', 'approved', 'description','coba'];
  ...
  ConvertToCSV(objArray:any, headerList:any) {
    ...
    let newHeaders = ['name','age', 'average', 'approved', 'description','coba'];
